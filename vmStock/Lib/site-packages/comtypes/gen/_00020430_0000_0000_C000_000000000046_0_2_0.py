...
__all__ = [ 'StdFont', 'OLE_YSIZE_CONTAINER', 'OLE_XPOS_HIMETRIC',
           'OLE_TRISTATE', 'Font', 'Default', 'OLE_YPOS_HIMETRIC',
           'StdPicture', 'OLE_COLOR', 'Color',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_HANDLE', 'Checked',
           'OLE_CANCELBOOL', 'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_PIXELS',
           'FontEvents', 'VgaColor', 'OLE_XSIZE_CONTAINER',
           'LoadPictureConstants', 'FONTUNDERSCORE', 'FONTBOLD',
           'OLE_YPOS_CONTAINER', 'IPictureDisp', 'IFontEventsDisp',
           'FONTSIZE', 'Gray', 'Unchecked', 'OLE_XPOS_PIXELS',
           'IFontDisp', 'OLE_OPTEXCLUSIVE', 'Monochrome',
           'OLE_XPOS_CONTAINER', 'FONTNAME', 'Picture',
           'OLE_YSIZE_PIXELS', 'FONTSTRIKETHROUGH', 'FONTITALIC',
           'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS', 'IFont',
           'IPicture']
from comtypes import _check_version; _check_version('1.1.11', 1575709751.8173304)
